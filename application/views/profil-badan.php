        ...
        <section class="breadcrumb-area" style="background-image: url(<?php echo base_url().'assets/'?>images/resources/kantorbkd.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                    ...
                    <div class="col-xl-12">
                        <div class="intro-box clearfix">
                            ...
                            <div class="text">
                                ...
                                <br> <a class="btn-one" href="/tupoksi">Tugas, Pokok & Fungsi BKD Provinsi NTB<span class="flaticon-next"></span></a>
                                </div>
                        </div>
                    </div>
                </div>
