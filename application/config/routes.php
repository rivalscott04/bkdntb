...
$route['admin/bidang'] = 'admin_bidang';
$route['admin/bidang/tambah'] = 'admin_bidang/tambah';
$route['admin/bidang/simpan'] = 'admin_bidang/simpan';
$route['admin/bidang/hapus'] = 'admin_bidang/hapus';
$route['admin/bidang/edit/(:num)'] = 'admin_bidang/edit/$1';
...
$route['admin_bidang'] = 'admin_bidang';
$route['admin_bidang/tambah'] = 'admin_bidang/tambah';
$route['admin_bidang/simpan'] = 'admin_bidang/simpan';
$route['admin_bidang/hapus'] = 'admin_bidang/hapus';
$route['admin_bidang/edit/(:num)'] = 'admin_bidang/edit/$1';
$route['kds'] = 'kadis';
